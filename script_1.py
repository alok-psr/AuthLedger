...
const APP_DATA = {
  ...
  mockCertificates: [
    {
      ...
      qrData: "SIH_CERT001_BPIT_CS_2024_KAAVY_AGGRAWAL_VERIFIED",
    ...
    },
    {
      ...
      qrData: "SIH_CERT002_MAIT_ML_2024_KAAVY_AGGRAWAL_VERIFIED",
  ...
  analyticsData: {
    ...
    institutionStats: [
      ...
      {"name": "VIPS", "certificates": 4890, "verified": 4850, "success": 99.2},
      ...
      certificates: [
        {
          ...
          qrData: "VERIFY:CERT_001:VIPS:CS:2024:KAAVY_AGGRAWAL:0xabc123",
          uploadDate: "2024-01-15",
          verificationCount: 5,
          aiConfidence: 98.9,
          fraudRisk: "LOW",
